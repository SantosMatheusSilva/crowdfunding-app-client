...
function CreateCampaign () {
    ...
    return (
        <div className="max-w-2xl mx-auto p-20 mt-10 ">
            <div>
                <h1 className="text-3xl font-bold text-center p-5  bg-blue-500 text-white font-semibold rounded-md">Create a Campaign</h1>
            </div>
